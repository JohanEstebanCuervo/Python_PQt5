# -*- coding: utf-8 -*-
"""
Created on Tue Dec 28 08:11:27 2021

@author: Johan Esteban Cuervo
"""
...
def setear_config_cam(cam,nodemap,VGamma=1.25,VExposureTime=8000,VGain=0,VSharpness=1800,VBlackLevel=0.7):
...
def configure_crown(comunicacion,time_sleep):
    result=True
    intensidades_leds = ["J1090K","J2090K","J3090K","J4090K","J5090K","J6090K",
		                 "J7090K","J8090K","J9090K","JA090K","JB090K","JC090K",
                         "JD080K","JE010K","JF010K"]
        ...
        if CHOSEN_TRIGGER == TriggerType.SOFTWARE:
            ...
            try:
                ...
                if image_result.IsIncomplete():
                    ...
                    filename = 'Imagenes\Acquisition_'+str(now.year)+str(now.month)+str(now.day)+str(now.hour)+str(now.minute)+'_'+Led[2]+'.bmp'
...
def main():
    ...
    Error_check=0
    Lista_Leds = ['M01N','M02N','M03N','M04N','M05N','M06N','M07N','M08N','M09N','M0AN','M0BN','M0CN','M0DN','M0EN','M0FN']

    port = Serial_Port_Select()
    comunicacion = serial.Serial(port,57600)
    ...
    escuchador.start()
    exit=0
    while escuchador.is_alive() and exit==0:
        pass
